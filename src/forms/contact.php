...
if ($_SERVER["REQUEST_METHOD"] !== "POST") {
    echo "Contact form endpoint is working. Waiting for POST request.";
    exit;
}
...
$recipient = "przemyslaw.pietkun@gmail.com";
...
$email_headers = "From: Passionate Hikers Club <przemyslaw.pietkun@gmail.com>\r\n";
